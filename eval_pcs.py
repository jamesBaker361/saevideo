#stolen from https://github.com/zhangxulu1996/awesome-personalization/blob/main/project/utils/clip_eval.py
...
class CLIPEvaluator(object):
    ...
    def get_image_features(self, img:list[Image.Image], norm: bool = True) -> torch.Tensor:
    ...
    def img_to_img_similarity(self, generated_images:list[Image.Image], src_images=None, src_img_features=None):
    ...
    def txt_to_img_similarity(self, generated_images:list[Image.Image], text=None, text_features=None):
